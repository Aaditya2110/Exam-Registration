   ...
   <?php require_once('header.php'); ?>
    ...
    <div class=" mcontainer">
        <form name="register" method="post" class="myform" action="" enctype="multipart/form-data">
            <h1 class="tit"> Backlog Registration</h1>
            <?php echo @$err; ?>
            ...
            <table width="100%">
                ...
                <tr>
                    <td>
                        <label class="label required">Roll No</label>
                    </td>
                    <td>

                    </td>
                    <td class="td1">
                        <input type="text" name="USN" autocomplete="off" placeholder="20XXBTECHXXX" required />
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="td1">
                        <input type="email" name="mail" autocomplete="off" placeholder="student@jklu.edu.in" required />
                    </td>
                </tr>
                ...
                <tr>
                    <td>
                        <label class="label required">Backlog Subject</label>
                    </td>
                    <td>

                    </td>
                    <td class="td1" class="label required">
                        <input  0000 placeholder="All Backlog Subjects" required />
                    </td>
                </tr>
