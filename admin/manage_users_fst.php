<?php
    ...
    $query1 = "SELECT * FROM fst_reg";
    $result = mysqli_query($con,$query1);
    $rr=mysqli_num_rows($result);
    if(!$rr)
    {
    echo "<h2 style='color:red;color:#ff0000;font-family:Acme;position:relative;top:35px;left:30%;''>No Students have Registered For Backlog Exams Yet.</h2>";
    }
    else
    {
?>
...
<body>
    ...
    <br /><br /><br /><br /><br /><br />
    <h2 style="color:#ff0000;font-family:'Acme';" class = "page-header"><u>Students Registered For Backlog :</u></h2>
                ...
                while($row = mysqli_fetch_array($result)) 
                    {
                        ...
                        echo "<td style='border:2px solid black'>".$row['fname'].' '.$row['lname']."</td>";
                        echo "<td style='border:2px solid black'>".$row['usn']."</td>";
...
<script>
        ...
        saveAs(new Blob([s2ab(wbout)],{type:"application/octet-stream"}), 'back.xlsx');
        });
</script>
</script>
