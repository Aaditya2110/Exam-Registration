<?php
    ...
    $id = $_GET['id'];
    $query = mysqli_query($con,"SELECT * from add_fst WHERE id = '$id'");
...
<?php
    ...
    if(isset($Update))
    {
    $q = "UPDATE add_fst set sub_name = '$sname',sub_code = '$scode',credits = '$credits',sem = '$sem' where id = '$id'";
...
<head>
    ...
    <title>Update/Edit Backlog Subject</title>
</head>
<body>
    <h1 class = "mh1" style = "color:black;">Update/Edit Backlog Subject</h1>
    <div class = "forms">
        <form class = "myform" method = "post">
            ...
            <table width = "100%">
                ...
                <tr>
                    ...
                    <td class = "td1">
                        <select name = "sem" class = "select1" placeholder = "" required value="<?php echo $row['sem'] ?>">
                            <option name = "s2" selected> 1 </option>
                            <option name = "s3"> 2 </option>
                            <option name = "s4"> 3 </option>
                            <option name = "s5"> 4 </option>
                            <option name = "s2"> 5 </option>
                            <option name = "s3"> 6 </option>
                            <option name = "s4"> 7 </option>
                            <option name = "s5"> 8 </option>
                        </select>
                    </td>
                </tr>
            </table>
