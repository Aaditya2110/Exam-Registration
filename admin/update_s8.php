...
$id = $_GET['id'];
$query = mysqli_query($con, "SELECT * from add_s8 WHERE id = '$id'");
...
extract($_POST);
if (isset($Update)) {
    $q = "UPDATE add_s8 set sub_name = '$sname',sub_code = '$scode',credits = '$credits' where id = '$id'";
...
<head>
    ...
    <title>Update/Edit | 8th Sem</title>
</head>

<body>
    <h1 class="mh1" style="color:black;">Update/Edit 8th Semester Subject</h1>
    <div class="forms">
