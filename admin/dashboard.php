...
<head>
    ...
    <!--Custom Favicon -->
    <link rel="icon" type="image/png" sizes="64x64" href="../ab.png">
    <style>
        .back-to-top {
            position: fixed;
            bottom: 25px;
...
<body>
    ...
    <div class="wrapper">
        <div class="sidebar col -l2 -s6">
            <ul>
                <div>
                    <img  src="../jklu.png" width="100" height="100" alt="not found" />
                </div>
                <li><a href="dashboard.php"><i class="fas fa-clipboard"></i>Dashboard</a></li>
                <li><a href="dashboard.php?page=manage_users"><i class="fas fa-users"></i>ALL Students</a></li>
                <li><a href="dashboard.php?page=manage_users_fst"><i class="fas fa-users"></i>Backlog Students</a></li>
                <li>
                    <div class="mdbtn">
                ...
                <li><a href="dashboard.php?page=add_fst"><i class="fas fa-plus"></i>Add Subject [Backlog]</a></li>
                <li><a href="dashboard.php?page=manage_sub_fst"><i class="fas fa-bars"></i>Manage Backlog &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Subjects</a></li>
            </ul>
        </div>
                                ...
                                <div class="row" style="margin-top:3%;">
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                        <a class="dashboard-stat1" href="dashboard.php?page=manage_users_fst">
                                            ...
                                            <span class="name">Students Registered<br />For Backlog Exam</span>
                                            <span class="bg-icon"><i class="fa fa-users"></i></span>
                                        </a>
                                        <!-- /.dashboard-stat -->
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                        <a class="dashboard-stat11" href="dashboard.php?page=manage_sub_fst">
                                            ...
                                            <span class="name">Subjects Listed<br />For Backlog</span>
                                            <span class="bg-icon"><i class="fa fa-bars"></i></span>
                                        </a>
                                        <!-- /.dashboard-stat -->
                                    </div>
