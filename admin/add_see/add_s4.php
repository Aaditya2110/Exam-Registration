...
extract($_POST);
if (isset($Add)) {
    $sql = "INSERT INTO add_s4 VALUES ('','$sname','$scode','$credit')";
...
<head>
    ...
    <title>Add Subject | 4th Sem</title>
</head>

<body>
    <h1 class="mh1" style="color:black;">Add Subject To 4th Semester</h1>
    <div class="forms">
        <form class="myform" method="post">
            ...
            <input type="reset" class="reset_btn" value="Reset" 99 onClick="window.location.href=window.location.href" />
        </form>
    </div>
