<?php
    ...
    $id = $_GET['id'];
    $query = mysqli_query($con,"SELECT * from add_s5 WHERE id = '$id'");
...
<?php
    ...
    if(isset($Update))
    {
    $q = "UPDATE add_s5 set sub_name = '$sname',sub_code = '$scode',credits = '$credits' where id = '$id'";
...
<head>
    ...
    <title>Update/Edit Subject | 5th Sem</title>
</head>
<body>
    <h1 class = "mh1" style = "color:black;">Update/Edit 5th Semester Subject</h1>
    <div class = "forms">
