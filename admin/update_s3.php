...
$id = $_GET['id'];
$query = mysqli_query($con, "SELECT * from add_s3 WHERE id = '$id'");
...
extract($_POST);
if (isset($Update)) {
    $q = "UPDATE add_s3 set sub_name = '$sname',sub_code = '$scode',credits = '$credits' where id = '$id'";
    $run = mysqli_query($con, $q);
    if ($run) {
        $err = "<font color='green' align='center'>Subject Updated Successfully...!</font>";
        header('location:dashboard.php?page=disp_s3');
    } else {
...
<head>
    ...
    <title>Update/Edit Subject | 3rd Sem</title>
</head>

<body>
    <h1 class="mh1" style="color:black;">Update/Edit 3rd Semester Subject</h1>
    <div class="forms">
        <form class="myform" method="post">
            ...
            <table width="100%">
                ...
                <tr>
                    ...
                    <td class="td1">
                        <select name="credits" class="select1" placeholder="" required value="<?php echo $row['sub_name'] ?>">
