<?php
    ...
    if(isset($Add))
    {
        $sql = "INSERT INTO add_fst VALUES ('','$sname','$scode','$credit','$sem')";
...
<head>
    ...
    <title>Add Subject To Backlog</title>
</head>
<body>
    <h1 class = "mh1" style = "color:black;">Add Subject To Backlog</h1>
    <div class = "forms">
        <form class = "myform" method = "post">
            ...
            <table width = "100%">
                ...
                <tr>
                    ...
                    <td class = "td1">
                        <select name = "sem" class = "select1" placeholder = "" required>
