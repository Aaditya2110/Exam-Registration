...
$id = $_GET['id'];
$query = mysqli_query($con, "SELECT * from add_s7 WHERE id = '$id'");
...
extract($_POST);
if (isset($Update)) {
    $q = "UPDATE add_s7 set sub_name = '$sname',sub_code = '$scode',credits = '$credits' where id = '$id'";
...
<head>
    ...
    <title>Update/Edit Subject | 7th Sem</title>
</head>

<body>
    <h1 class="mh1" style="color:black;">Update/Edit 7th Semester Subject</h1>
    <div class="forms">
