<?php
    ...
    $id = $_GET['id'];
    $query = mysqli_query($con,"SELECT * from add_s6 WHERE id = '$id'");
...
<?php
    ...
    if(isset($Update))
    {
    $q = "UPDATE add_s6 set sub_name = '$sname',sub_code = '$scode',credits = '$credits' where id = '$id'";
...
<head>
    ...
    <title>Update/Edit Subject | 6th Sem</title>
</head>
<body>
    <h1 class = "mh1" style = "color:black;">Update/Edit 6th Semester Subject</h1>
    <div class = "forms">
